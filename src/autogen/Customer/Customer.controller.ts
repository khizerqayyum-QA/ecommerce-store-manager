...
export class CustomerController implements CrudController<Customer> {
  ...
  create(@ParsedRequest() req: CrudRequest, @ParsedBody() dto: Customer) {
  ...
  createMany(
    ...
    @ParsedBody() dto: CreateManyDto<Customer>,
  ) {
  ...
  update(@ParsedRequest() req: CrudRequest, @ParsedBody() dto: Customer) {
    return this.base.updateOneBase(req, dto);
  }

  @Override('replaceOneBase')
  @ApiOperation({ summary: 'Replace a single Customer' })
  replace(@ParsedRequest() req: CrudRequest, @ParsedBody() dto: Customer) {
