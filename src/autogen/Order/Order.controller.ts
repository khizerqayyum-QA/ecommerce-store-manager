...
export class OrderController implements CrudController<Order> {
  ...
  @ApiOperation({ summary: 'Retrieve multiple Orders' })
  ...
  @ApiOperation({ summary: 'Create a single Order' })
  @ApiBody({
    type: OrderCreate,
    description:
  ...
  create(@ParsedRequest() req: CrudRequest, @ParsedBody() dto: Order) {
    return this.base.createOneBase(req, dto);
  }

  @Override('createManyBase')
  @ApiOperation({ summary: 'Create multipleOrders' })
  createMany(
  ...
  update(@ParsedRequest() req: CrudRequest, @ParsedBody() dto: Order) {
    return this.base.updateOneBase(req, dto);
  }

  @Override('replaceOneBase')
  @ApiOperation({ summary: 'Replace a single Order' })
  replace(@ParsedRequest() req: CrudRequest, @ParsedBody() dto: Order) {
